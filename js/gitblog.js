var gitblog = function(config) {
    ...
    var Footer = function() {
        ...
        this.icons = [];
        this.icon_num = 0;
        this.content = '我的GitHUb: <a href="https://github.com/EatFans" target="_blank" style="color: aquamarine;text-decoration:none;border-bottom: 1px solid #79f8d4;">EatFan</a>';
    }
